...
bool CAMLCodec::OpenDecoder(CDVDStreamInfo &hints)
{
  ...
  m_display_rect = CRect(0, 0, g_settings.m_ResInfo[g_guiSettings.m_LookAndFeelResolution].iWidth, g_settings.m_ResInfo[g_guiSettings.m_LookAndFeelResolution].iHeight);
  ...
  if (strScaler.find("enabled") == std::string::npos)     // Scaler not enabled, use screen size
    m_display_rect = CRect(0, 0, g_settings.m_ResInfo[g_guiSettings.m_LookAndFeelResolution].iScreenWidth, g_settings.m_ResInfo[g_guiSettings.m_LookAndFeelResolution].iScreenHeight);
...
void CAMLCodec::SetVideoRect(const CRect &SrcRect, const CRect &DestRect)
{
  ...
  CRect gui, display;
  gui = CRect(0, 0, g_settings.m_ResInfo[g_guiSettings.m_LookAndFeelResolution].iWidth, g_settings.m_ResInfo[g_guiSettings.m_LookAndFeelResolution].iHeight);
